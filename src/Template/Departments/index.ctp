...
<div class="input-group-prepend">
                <button  class="btn btn-primary input -group-text right"> <?=  $this->Html->link(__('Add Department'), ['controller' => 'Departments','action' => 'add']) ?></button>
            </div><br><br>
    <h3><?= __('Departments') ?></h3>
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                <th scope="col"><?= $this->Paginator->sort('Department id') ?></th>
                <th scope="col"><?= $this->Paginator->sort('Department name') ?></th>
