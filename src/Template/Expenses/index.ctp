...
<div class="input-group-prepend">
                <button  class="btn btn-primary input -group-text right"> <?=  $this->Html->link(__('Add Expenses'), ['controller' => 'Expenses','action' => 'add']) ?></button>
            </div><br><br>
    <h3><?= __('Expenses') ?></h3>
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('purchase from') ?></th>
                <th scope="col"><?= $this->Paginator->sort('purchase date') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $expense->id]) ?><br>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $expense->id]) ?><br>
